...
public class DataContainer_CellGameArchive
{
    ...
    public List<DataContainer_PanelCellStore> DataListCellStore = new List<DataContainer_PanelCellStore>();
    ...
    (string GameArchiveName, E_GameArchiveLevel e_GameArchiveLevel, string Location, string Week, string Time, 
     List<DataContainer_PanelCellStore> DataListCellStore)
    {
...
public class DataContainer_PanelCellStore
{
    public E_SpriteNamePanelCellTownStore e_PanelCellStorePrefabName = E_SpriteNamePanelCellTownStore.StoreWood;
    public int MaxWeight = 0;
    public int NowWeight = 0;
    public int MaxCapacity = 0;
    public int NowCapacity = 0;

    public DataContainer_PanelCellStore() { }
    public DataContainer_PanelCellStore
    (E_SpriteNamePanelCellTownStore e_PanelCellStorePrefabName)
    {
