...
public class PanelExpeditionPrepare : PanelBase
{
    ...
    public void Refresh()
    {
        Hot.DataNowCellGameArchive.ExpeditionPrepare.Darkest.
            Add(Hot.MgrJson_.Load<DataContainer_ExpeditionMiniMap>(Hot.PanelOtherEditorMiniMap_.PathFolder + "/Default", "/Map0"));
        Hot.DataNowCellGameArchive.ExpeditionPrepare.Darkest.
            Add(Hot.MgrJson_.Load<DataContainer_ExpeditionMiniMap>(Hot.PanelOtherEditorMiniMap_.PathFolder + "/Default", "/Map1"));
    }
}
